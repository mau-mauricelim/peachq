/* q_type — THE q-side type-axis home: lane accessors and predicates the q layer
 * needs beyond the base's (as_i64/as_f64/is_numeric_or_temporal and the arith
 * result-type lattice stay in lang/internal.h, unfrozen since #677), the
 * tag<->char map, and the mixed-pair result-type matrix. */
