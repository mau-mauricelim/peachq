...
.help.i.r[`asc;"asc 2 1 3 2                         / `s#1 2 2 3              sort a list, dictionary or table ascending"]
...
.help.i.r[`insert;"t:([]a:1 2;b:`x`y);`t insert(3;`z)  / ,2                      append records to a table named by symbol"]
.help.i.r[`inter;"1 2 3 inter 2 3 4                   / 2 3                     keep the items that appear in both lists"]
.help.i.r[`inv;"inv 2 2#1 0 0 1f                    / (1 0f;0 1f)             invert a non-singular float matrix"]
...
.help.i.r[`lsq;"(1 2#1 2f)lsq 2 2#1 0 0 1f          / ,1 2f                   solve x=y by least squares matrix divide"]
...
.help.i.r[`upsert;"t:([a:1 2]b:`x`y);`t upsert(1;`z)   / `t                      append records, replacing any with a matching key"]
...
.help.i.r[`.Q.k;".Q.k                                /                         report the kdb+ compatibility level as a float (5.0), as .z.K does"]
.help.i.r[`.Q.K;".Q.K                                /                         report the interpreter version date"]
.help.i.r[`.Q.opt;".Q.opt .z.x                         /                         read command-line arguments as a dictionary"]
.help.i.r[`.Q.def;".Q.def[`p!enlist 80;()!()]          /                         apply defaults and types to parsed command-line arguments"]
...
.help.i.r[`.z.K;".z.K                                /                         report the kdb+ compatibility level as a float (5.0)"]
...
.help.i.r[`.z.v;".z.v                                /                         peachq version and environment (version QCFG QHOME QLIC QINIT QPATH)"]
...
.help.i.r[`$"'mismatch";"([]a:1 2),([]b:3 4)                 /                         the tables or dictionaries do not line up"]
.help.i.r[`$"'insert";"t:([a:1 2j]b:3 4);`t insert(1j;5)   /                         a keyed insert would duplicate a key that is already there"]
